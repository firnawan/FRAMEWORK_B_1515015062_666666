...
class Jadwal_matakuliah extends Model
{
   ...
   public function Dosen_MataKuliah(){// fungsi dengan nama dosen_matakuliah
    	return $this->belongsTo(DosenMataKuliah::class);// memberikan nilai return dari fungsi belongsTo yang merelasikan dosen_matakuliah dengan banyak jadwal_Matakuliah
   }
